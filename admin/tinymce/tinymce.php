...
class add_pinterestimport_button
{
     ...
     * @return void
     */
    function add_pinterestimport_button()
    {
        // Set path to editor_plugin.js
        $this->path = PINIMP_URLPATH . 'admin/tinymce/';
...
// Call it now
$tinymce_button = new add_pinterestimport_button();
